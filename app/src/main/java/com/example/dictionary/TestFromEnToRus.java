...
public class TestFromEnToRus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_from_en_to_rus);

        question = findViewById(R.id.en_question);
        wordsLeftCounter = findViewById(R.id.wordsCounter);
        answer = findViewById(R.id.rus_answer);
        prior = findViewById(R.id.en_to_rus_prior);
        word_id = findViewById(R.id.en_word_id);
        ...
        word_id.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TestFromEnToRus.this, UpdateActivity.class);
        ...
        next_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                answer_button = findViewById(R.id.answer_button2);
