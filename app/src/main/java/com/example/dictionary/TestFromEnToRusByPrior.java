...
public class TestFromEnToRusByPrior extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_from_en_to_rus_by_prior);

        question = findViewById(R.id.en_question2);
        answer = findViewById(R.id.rus_answer2);
        prior = findViewById(R.id.en_to_rus_prior2);
        word_id = findViewById(R.id.en_word_id2);
        ...
        cursor.close();
        next_button = findViewById(R.id.en_next_button);
        ...
        word_id.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TestFromEnToRusByPrior.this, UpdateActivity.class);
        ...
        next_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                id = Random(enWords.size());
                question.setText(enWords.get(id));
                answer_button = findViewById(R.id.rus_answer_button);
                answer_button.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {

                        answer.setText(rusWords.get(id));
